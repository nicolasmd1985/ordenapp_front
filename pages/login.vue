        ...
        <div class="card-body px-lg-5 text-center">
          ...
          <form @submit.prevent="submit" method="post" novalidate="true">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <div class="form__field--input md-form">
                  <label for="user_password" data-error="wrong" data-success="right">
                    Password
                  </label>
                  <input v-model="password" type="password" id="user_password" name="user[password]" autocomplete="current-password" class="form-control validate" style="margin-bottom: 0.5rem;" placeholder="Password" required>

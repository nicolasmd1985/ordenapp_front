          ...
          <div id="form_new_email">
            ...
            <!-- <%= render "devise/shared/error_messages", resource: resource %> -->
              <div class="row">
                <div class="col-6">
                  <div class="form__field--input md-form field verify_name validate_field">
                    ...
                    <label for="autocomplete-name" data-error="wrong" data-success="right">Name</label>
                    ...
                    <input type="text" name="first_name" id="autocomplete-name" autofocus required minlength=3 class="form-control validate" autocomplete="nope" style="margin-bottom: 0.5rem;">
                ...
                <div class="col">
                  ...
                  <div class="form__field--input md-form field verify_corporation validate_field">
                    ...
                    <!-- <input type="text" name="corporation_id" id="autocomplete-corporation" class="input-field autocomplete form-control validate" autocomplete="off" minlength="3" required="true" style="margin-bottom: 0.5rem;">
                    <div class="invalid-feedback">
                  ...
                  <div class="form__field--input md-form field verify_email validate_field">
                    ...
                    <input type="email" name="email" id="email" value="email" placeholder="example@mail.com" autofocus="true" autocomplete="email" class="form-control validate" style="margin-bottom: 0.5rem;">
                    <!-- <div class="invalid-feedback">
                  ...
                  <div class="form__field--input md-form field verify_pass validate_field">
                    ...
                    <input type="password" name="password" id="user_password" autocomplete="new-password" class="form-control">
              ...
              <div class="row justify-content-center flex-column align-items-center">
                <button class="btn btn-outline-success btn-rounded btn-block form__submit my-4" type="submit" id="register">
                ...
                <p>
                  ...
                  <!-- <a href="/en/users/sign_in" class="form-link"> -->
                    <nuxt-link to="/en/users/sign_in" class="form-link">
